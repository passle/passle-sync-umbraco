...
namespace PassleSync.Core.Helpers
{
    public static class PostHelper
    {
        ...
        public static string TwitterShareUrl(string postUrl, string postTitle, string[] tags, List<PostAuthor> authors)
        {
            string authorHashTags = string.Join(", ", authors.Select(a => string.IsNullOrEmpty(a.TwitterScreenName) ? a.Name : $"@{a.TwitterScreenName}"));
