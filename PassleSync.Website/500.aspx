...
<% 
    ...
    var showError = environment.Equals("development") || environment.Equals("staging");
%><!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <% if (showError && ex != null) { %>
        <hr style="margin-top: 150px;">
        <div style="padding: 50px;">
            <h2><%=ex.Message %></h2>
            <p><strong>Source:</strong> <code><pre><%=ex.Source%></pre></code></p>
            <p><strong>Stack Trace:</strong> <code><pre><%=ex.StackTrace %></pre></code></p>
            <p></p>
        </div>
    <% } %>

    <footer><p>Technical Contact: <a href="mailto:support@Passle.com">support@Passle.com</a></p></footer>
</body>
</html>
